// apps/dynatrace-tools/index.js
// HTTP Cloud Function that provides Dynatrace tools for Agent Builder
// Each tool is exposed as a separate HTTP endpoint
...
functions.http('get_problem_details', async (req, res) => {
  try {
...
functions.http('get_affected_entities', async (req, res) => {
  try {
    const { problemId } = req.body;
...
// ─── Tool: query_metrics ──────────────────────────────────────────────
functions.http('query_metrics', async (req, res) => {
  try {
...
// ─── Tool: fetch_logs ─────────────────────────────────────────────────
functions.http('fetch_logs', async (req, res) => {
  try {
...
functions.http('write_reasoning_step', async (req, res) => {
  try {
